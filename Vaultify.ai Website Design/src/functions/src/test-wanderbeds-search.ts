...
import { searchHotels } from './vendors/wanderbeds/wanderbedsApi';
...
async function testSearch() {
  ...
  try {
    const result3 = await searchHotels({
      hotels: [2657],
      checkin: '2026-02-02',
      checkout: '2026-02-07',
      rooms: [{ adt: 1 }],
  ...
  try {
    const result4 = await searchHotels({
      hotels: ['2657'] as any,
      checkin: '2026-02-02',
      checkout: '2026-02-07',
      rooms: [{ adt: 1 }],
  ...
  console.log('\n=== Test 5: Multiple hotels including 2657 ===');
  try {
    const result5 = await searchHotels({
      hotels: [2657, 1646],
      checkin: '2026-02-02',
      checkout: '2026-02-07',
      rooms: [{ adt: 1 }],
